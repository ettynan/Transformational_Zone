...
import { ArrowRight, Sparkles, Footprints, Flame } from "lucide-react";
      ...
      <main id="home-main">
        <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="/images/zen-sand-and-water.jpg" alt="Sand and water" className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-stone-900/20" />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-stone-50/90" />
          </div>

          <div className="container relative z-10 px-4 text-center -translate-y-12">
            <motion.div
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/services" className="inline-flex justify-center">
                  <span className="px-8 py-3.5 rounded-full bg-white text-stone-900 font-medium hover:bg-stone-100 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                    Explore Services
                  </span>
                </Link>

                <Link href="/contact" className="inline-flex justify-center">
                  <span className="px-8 py-3.5 rounded-full bg-primary/90 text-white backdrop-blur-sm border border-transparent font-medium hover:bg-primary transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                    Request Appointment
                  </span>
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeIn}>
                ...
                <Link href="/about">
                  <span className="inline-flex items-center text-primary font-semibold hover:text-primary/80 transition-colors cursor-pointer group">
                    ...
                    <ArrowRight aria-hidden="true" className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
                  </span>
                </Link>
              </motion.div>
              ...
              <motion.div {...fadeIn} className="relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                  <img src="/images/zen-sand-replacement.jpg" alt="Smooth zen stones in sand" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-6xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-stone-600 font-medium mb-6 leading-relaxed">
                    Uses soothing heat to ease tension, improve circulation, and calm the nervous system, preparing the body for deeper healing.
                  </p>
                </motion.div>
