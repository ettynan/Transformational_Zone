        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg bg-stone-200">
              {/* Unsplash: generic nature/stone image, no people */}
              <img 
                src="/images/blue-butterfly.jpg" 
                alt="Blue Butterfly" 
            ...
            <div>
              ...
              <div className="p-6 bg-white border border-stone-100 rounded-xl shadow-sm">
                <h4 className="font-heading text-xl mb-2 text-primary">Certifications</h4>
          ...
          <div className="text-center bg-stone-300 text-white p-12 rounded-3xl shadow-lg">
            <h2 className="font-heading text-3xl mb-4 leading-relaxed">"The natural healing force within each of us is the greatest force in getting well."</h2>
            <p className="text-stone-10 text-lg tracking-wide">— Hippocrates</p>
          </div>
        </div>
      </div>
      <Footer />
